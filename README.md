...
This repository contains simulations for submersible injection pump fault diagnosis using the AEKF algorithm, supporting the paper presented at the IEEE Conference on Decision and Control (CDC).
...
@INPROCEEDINGS{AEKF-Pump,
  ...
  number={},
  pages={502-508},
  doi={10.1109/CDC57313.2025.11312946}
}
```
